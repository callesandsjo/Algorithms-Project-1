...
bool PriorityQueueUnitTests(size_t iterations)
{
    if constexpr (PriorityQueue_has_constructor)
    {
        ...
        if (!TestEnqueue())
        {
            std::cout << "Tests failed on PriorityQueue::enqueue. No further testing can be conducted." << std::endl;
            return false;
        }
        if (!TestSize())
        {
            std::cout << "Tests failed on PriorityQueue::size. No further testing can be conducted." << std::endl;
            return false;
        }
        if (!TestIsEmpty())
        {
            std::cout << "Tests failed on PriorityQueue::isEmpty. No further testing can be conducted." << std::endl;
            return false;
        }
        if (!TestPeek())
        {
            std::cout << "Tests failed on PriorityQueue::peek. No further testing can be conducted." << std::endl;
            return false;
        }
        if (!TestDequeue())
        {
            std::cout << "Tests failed on PriorityQueue::dequeue. No further testing can be conducted." << std::endl;
            return false;
        }
        if (!TestThrow())
        {
            std::cout << "Tests failed on exception handling. No further testing can be conducted." << std::endl;
            return false;
        }
